import { Dt as mergeProps, cn as useId } from "./vue.runtime.esm-bundler-DFMfLOW_.js";
import { B as z, M as c, _ as s, c as F, d as c$1, f as g, h as m, n as N, r as S, s as C, t as BaseStyle, u as a } from "./style-DAneQRWM.js";
...
var script = {
	...
	beforeMount: function beforeMount() {
		...
		if (this.rootEl) this.rootEl.$pc = _objectSpread({
			name: this.$.type.name,
	...
	methods: {
		...
		_loadGlobalStyles: function _loadGlobalStyles() {
			...
			s(globalCSS) && BaseStyle.load(globalCSS, _objectSpread({ name: "global" }, this.$styleOptions));
		},
		...
		_loadScopedThemeStyles: function _loadScopedThemeStyles(preset) {
			...
			this.scopedStyleEl = ((_this$$style1 = this.$style) === null || _this$$style1 === void 0 ? void 0 : _this$$style1.load(css, _objectSpread({ name: "".concat(this.$attrSelector, "-").concat(this.$style.name) }, this.$styleOptions))).el;
		},
		...
		_getOptionValue: function _getOptionValue(options) {
			return F(options, arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "", arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {});
		},
	...
	computed: {
		globalPT: function globalPT() {
			...
			return this._getPT((_this$$primevueConfig4 = this.$primevueConfig) === null || _this$$primevueConfig4 === void 0 ? void 0 : _this$$primevueConfig4.pt, void 0, function(value) {
				return m(value, { instance: _this3 });
			});
		},
...
//# sourceMappingURL=basecomponent-Do__eKXt.js.map