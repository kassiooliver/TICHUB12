import { $ as createTextVNode, Cn as withDirectives, Dt as mergeProps, G as createBlock, Jt as renderSlot, K as createCommentVNode, Vt as openBlock, W as createBaseVNode, Xt as resolveDirective, Yt as resolveComponent, Zt as resolveDynamicComponent, ar as normalizeClass, cr as toDisplayString, q as createElementBlock, xn as withCtx } from "./vue.runtime.esm-bundler-DFMfLOW_.js";
import { C as P, D as Tt, O as U, R as v, T as Rt, V as f, _ as s, b as K, c as F, d as c, f as g, g as ne, h as m, k as W, m as l, n as N, o as s$1, p as i, r as S, s as C, t as BaseStyle, u as a, v as C$1, w as Q } from "./style-DAneQRWM.js";
import { n as Base, t as script$4 } from "./basecomponent-Do__eKXt.js";
import { t as script$5 } from "./baseicon-CYrhbvzF.js";
import { t as PrimeVueService } from "./service-DwvjNINZ.js";
...
var script$2 = {
	...
	computed: { dataP: function dataP() {
		return f(_defineProperty$4(_defineProperty$4({
...
var BaseDirective = {
	...
	_getPTValue: function _getPTValue() {
		...
		var getValue = function getValue() {
			...
			return a(value) || C(value) ? { "class": value } : value;
		};
		...
		var self = BaseDirective._usePT(instance, BaseDirective._getPT(obj, instance.$name), getValue, key, _objectSpread(_objectSpread({}, params), {}, { global: global || {} }));
	...
	_getPTDatasets: function _getPTDatasets() {
		...
		return _objectSpread(_objectSpread({}, key === "root" && _defineProperty$3({}, "".concat(datasetPrefix, "name"), g(instance.$name))), {}, _defineProperty$3({}, "".concat(datasetPrefix, "section"), g(key)));
	},
	...
	_loadThemeStyles: function _loadThemeStyles() {
		...
		if (!S.isStyleNameLoaded("common")) {
			...
			BaseStyle.load(primitive === null || primitive === void 0 ? void 0 : primitive.css, _objectSpread({ name: "primitive-variables" }, useStyleOptions));
			BaseStyle.load(semantic === null || semantic === void 0 ? void 0 : semantic.css, _objectSpread({ name: "semantic-variables" }, useStyleOptions));
			BaseStyle.load(global === null || global === void 0 ? void 0 : global.css, _objectSpread({ name: "global-variables" }, useStyleOptions));
			BaseStyle.loadStyle(_objectSpread({ name: "global-style" }, useStyleOptions), style);
		...
		if (!S.isStyleNameLoaded((_instance$$style5 = instance.$style) === null || _instance$$style5 === void 0 ? void 0 : _instance$$style5.name) && (_instance$$style6 = instance.$style) !== null && _instance$$style6 !== void 0 && _instance$$style6.name) {
			...
			(_instance$$style8 = instance.$style) === null || _instance$$style8 === void 0 || _instance$$style8.load(css, _objectSpread({ name: "".concat(instance.$style.name, "-variables") }, useStyleOptions));
			(_instance$$style9 = instance.$style) === null || _instance$$style9 === void 0 || _instance$$style9.loadStyle(_objectSpread({ name: "".concat(instance.$style.name, "-style") }, useStyleOptions), _style);
	...
	_loadScopedThemeStyles: function _loadScopedThemeStyles() {
		...
		if (preset && instance.$attrSelector) {
			...
			instance.scopedStyleEl = ((_instance$$style10 = instance.$style) === null || _instance$$style10 === void 0 ? void 0 : _instance$$style10.load(css, _objectSpread({ name: "".concat(instance.$attrSelector, "-").concat(instance.$style.name) }, useStyleOptions))).el;
		}
	},
	...
	extend: function extend() {
		...
		return _objectSpread({ extend: function extend() {
...
var Ripple = BaseRipple.extend("ripple", {
	...
	methods: {
		...
		createRipple: function createRipple(el) {
			...
			if (!ink) {
				ink = U("span", _defineProperty$2(_defineProperty$2({
					role: "presentation",
					"aria-hidden": true,
					"data-p-ink": true,
			...
			return [renderSlot(_ctx.$slots, "default", {}, function() {
				return [
					...
					_ctx.label ? (openBlock(), createElementBlock("span", mergeProps({
						key: 2,
						"class": _ctx.cx("label")
					}, _ctx.ptm("label"), { "data-p": $options.dataLabelP }), toDisplayString(_ctx.label), 17, _hoisted_2)) : createCommentVNode("", true),
...
//#endregion
export { Ripple as n, BaseDirective as r, script as t };

//# sourceMappingURL=button-DMdHe2wk.js.map