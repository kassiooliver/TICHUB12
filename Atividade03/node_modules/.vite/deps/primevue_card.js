import { Dt as mergeProps, Jt as renderSlot, K as createCommentVNode, Vt as openBlock, W as createBaseVNode, q as createElementBlock } from "./vue.runtime.esm-bundler-DFMfLOW_.js";
import { t as BaseStyle } from "./style-DAneQRWM.js";
import { t as script$2 } from "./basecomponent-Do__eKXt.js";
//#endregion
//#region node_modules/primevue/card/style/index.mjs
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
	return openBlock(), createElementBlock("div", mergeProps({ "class": _ctx.cx("root") }, _ctx.ptmi("root")), [_ctx.$slots.header ? (openBlock(), createElementBlock("div", mergeProps({
	...
	}, _ctx.ptm("header")), [renderSlot(_ctx.$slots, "header")], 16)) : createCommentVNode("", true), createBaseVNode("div", mergeProps({ "class": _ctx.cx("body") }, _ctx.ptm("body")), [
		...
		createBaseVNode("div", mergeProps({ "class": _ctx.cx("content") }, _ctx.ptm("content")), [renderSlot(_ctx.$slots, "content")], 16),
