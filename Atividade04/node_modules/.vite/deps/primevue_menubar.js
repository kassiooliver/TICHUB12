import { Cn as withDirectives, Dt as mergeProps, G as createBlock, Jt as renderSlot, K as createCommentVNode, M as Fragment, Vt as openBlock, W as createBaseVNode, Xt as resolveDirective, Yt as resolveComponent, Zt as resolveDynamicComponent, ar as normalizeClass, cr as toDisplayString, et as createVNode, ft as guardReactiveProps, or as normalizeProps, q as createElementBlock, qt as renderList, sr as normalizeStyle } from "./vue.runtime.esm-bundler-CKUwx75R.js";
import { M as Yt, P as bt, U as z, _ as m, a as x, d as M, g as l, t as BaseStyle, u as J, y as s } from "./style-VNAtIxz_.js";
import { t as script$5 } from "./basecomponent-DoIfW6pZ.js";
import { t as script$6 } from "./baseicon-fU9s6PJA.js";
import "./service-C2uatRu2.js";
import { t as Ripple } from "./ripple-D1p29Hi3.js";
import { t as script$7 } from "./angledown-CByuTnKE.js";
//#region node_modules/@primevue/icons/bars/index.mjs
var script$4 = {
	name: "BarsIcon",
	"extends": script$6
};
...
//#endregion
//#region node_modules/primevue/menubar/style/index.mjs
var MenubarStyle = BaseStyle.extend({
	...
	inlineStyles: { submenu: function submenu(_ref) {
		var instance = _ref.instance, processedItem = _ref.processedItem;
		return { display: instance.isItemActive(processedItem) ? "flex" : "none" };
	} }
});
//#endregion
//#region node_modules/@primevue/icons/angleright/index.mjs
var script$3 = {
	name: "AngleRightIcon",
	"extends": script$6
};
...
//#endregion
//#region node_modules/primevue/menubar/index.mjs
var script$2 = {
	name: "BaseMenubar",
	"extends": script$5,
	props: {
	...
	methods: {
		...
		getMenuItemProps: function getMenuItemProps(processedItem, index) {
			return {
				...
				icon: mergeProps({ "class": [this.cx("itemIcon"), this.getItemProp(processedItem, "icon")] }, this.getPTOptions(processedItem, index, "itemIcon")),
				label: mergeProps({ "class": this.cx("itemLabel") }, this.getPTOptions(processedItem, index, "itemLabel")),
				submenuicon: mergeProps({ "class": this.cx("submenuIcon") }, this.getPTOptions(processedItem, index, "submenuIcon"))
			};
		}
	},
	computed: {
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createElementBlock("ul", mergeProps({ "class": $props.level === 0 ? _ctx.cx("rootList") : _ctx.cx("submenu") }, $props.level === 0 ? _ctx.ptm("rootList") : _ctx.ptm("submenu")), [(openBlock(true), createElementBlock(Fragment, null, renderList($props.items, function(processedItem, index) {
		return openBlock(), createElementBlock(Fragment, { key: $options.getItemKey(processedItem) }, [$options.isItemVisible(processedItem) && !$options.getItemProp(processedItem, "separator") ? (openBlock(), createElementBlock("li", mergeProps({
		...
		}, { ref_for: true }, $options.getPTOptions(processedItem, index, "item"), {
		...
		}, { ref_for: true }, $options.getPTOptions(processedItem, index, "itemContent")), [!$props.templates.item ? withDirectives((openBlock(), createElementBlock("a", mergeProps({
			key: 0,
			href: $options.getItemProp(processedItem, "url"),
			"class": _ctx.cx("itemLink"),
			target: $options.getItemProp(processedItem, "target"),
			tabindex: "-1"
		}, { ref_for: true }, $options.getPTOptions(processedItem, index, "itemLink")), [
			...
			}, { ref_for: true }, $options.getPTOptions(processedItem, index, "itemIcon")), null, 16)) : createCommentVNode("", true),
			createBaseVNode("span", mergeProps({
				id: $options.getItemLabelId(processedItem),
				"class": _ctx.cx("itemLabel")
			}, { ref_for: true }, $options.getPTOptions(processedItem, index, "itemLabel")), toDisplayString($options.getItemLabel(processedItem)), 17, _hoisted_4),
			$options.getItemProp(processedItem, "items") ? (openBlock(), createElementBlock(Fragment, { key: 2 }, [$props.templates.submenuicon ? (openBlock(), createBlock(resolveDynamicComponent($props.templates.submenuicon), {
				key: 0,
				root: $props.root,
			...
			}, { ref_for: true }, $options.getPTOptions(processedItem, index, "submenuIcon")), null, 16, ["class"]))], 64)) : createCommentVNode("", true)
		], 16, _hoisted_3)), [[_directive_ripple]]) : (openBlock(), createBlock(resolveDynamicComponent($props.templates.item), {
			key: 1,
			item: processedItem.item,
			root: $props.root,
			...
			"label",
			"props"
		]))], 16, _hoisted_2), $options.isItemVisible(processedItem) && $options.isItemGroup(processedItem) ? (openBlock(), createBlock(_component_MenubarSub, {
			key: 0,
			id: $options.getItemId(processedItem) + "_list",
			menuId: $props.menuId,
			role: "menu",
			style: normalizeStyle(_ctx.sx("submenu", true, { processedItem })),
			...
			"pt",
			"unstyled"
		])) : createCommentVNode("", true)], 16, _hoisted_1$1)) : createCommentVNode("", true), $options.isItemVisible(processedItem) && $options.getItemProp(processedItem, "separator") ? (openBlock(), createElementBlock("li", mergeProps({
			key: 1,
			id: $options.getItemId(processedItem),
			"class": [_ctx.cx("separator"), $options.getItemProp(processedItem, "class")],
			style: $options.getItemProp(processedItem, "style"),
			role: "separator"
		}, { ref_for: true }, _ctx.ptm("separator")), null, 16, _hoisted_5)) : createCommentVNode("", true)], 64);
	}), 128))], 16);
}
...
var script = {
	...
	beforeUnmount: function beforeUnmount() {
		...
		if (this.container) x.clear(this.container);
		this.container = null;
	},
	methods: {
		...
		isItemGroup: function isItemGroup(item) {
			return s(this.getItemProp(item, "items"));
		},
		...
		onItemClick: function onItemClick(event) {
			...
			var root = l(processedItem.parent);
		...
		onArrowRightKey: function onArrowRightKey(event) {
			var processedItem = this.visibleItems[this.focusedItemInfo.index];
			if (processedItem ? this.activeItemPath.find(function(p) {
				return p.key === processedItem.parentKey;
			}) : null) {
				if (this.isProccessedItemGroup(processedItem)) {
					this.onItemChange({
		...
		bindOutsideClickListener: function bindOutsideClickListener() {
			...
			if (!this.outsideClickListener) {
				this.outsideClickListener = function(event) {
					...
					if (isOutsideContainer && isOutsideTarget) _this5.hide();
				};
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createElementBlock("div", mergeProps({
		...
		renderSlot(_ctx.$slots, _ctx.$slots.button ? "button" : "menubutton", {
			id: _ctx.$id,
