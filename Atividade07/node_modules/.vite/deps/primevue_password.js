import { Dt as mergeProps, G as createBlock, Jt as renderSlot, K as createCommentVNode, Vt as openBlock, W as createBaseVNode, Yt as resolveComponent, Zt as resolveDynamicComponent, cr as toDisplayString, et as createVNode, n as Transition, q as createElementBlock, xn as withCtx } from "./vue.runtime.esm-bundler-CKUwx75R.js";
import { C as D, G as v, I as Yt, J as f, M as S, a as x, t as BaseStyle, w as I, x as At } from "./style-zV7_3CTQ.js";
import { t as s } from "./eventbus-BFUtkwWu.js";
import "./basecomponent-CyZyZ_FO.js";
import { t as script$4 } from "./baseicon-I8adJg6o.js";
import { t as script$5 } from "./times-DD9JzGTY.js";
import { t as script$6 } from "./portal-DksfPocx.js";
import { n as script$7, t as script$8 } from "./inputtext-Bez7Z9VD.js";
...
//#endregion
//#region node_modules/@primevue/icons/eye/index.mjs
var script$3 = {
	name: "EyeIcon",
	"extends": script$4
};
...
//#endregion
//#region node_modules/@primevue/icons/eyeslash/index.mjs
var script$2 = {
	name: "EyeSlashIcon",
	"extends": script$4
};
...
//#endregion
//#region node_modules/primevue/password/style/index.mjs
var PasswordStyle = BaseStyle.extend({
	...
	inlineStyles: { root: function root(_ref) {
		return { position: _ref.props.appendTo === "self" ? "relative" : void 0 };
	} }
});
//#endregion
//#region node_modules/primevue/password/index.mjs
var script$1 = {
	name: "BasePassword",
	"extends": script$7,
	props: {
...
var script = {
	...
	methods: {
		...
		alignOverlay: function alignOverlay() {
			if (this.appendTo === "self") I(this.overlay, this.$refs.input.$el);
			else {
		...
		onBlur: function onBlur(event) {
			this.focused = false;
			if (this.feedback) this.overlayVisible = false;
		...
		bindScrollListener: function bindScrollListener() {
			var _this = this;
			if (!this.scrollHandler) this.scrollHandler = new ConnectedOverlayScrollHandler(this.$refs.input.$el, function() {
				if (_this.overlayVisible) _this.overlayVisible = false;
			});
		...
		bindResizeListener: function bindResizeListener() {
			...
			if (!this.resizeListener) {
				this.resizeListener = function() {
					if (_this2.overlayVisible && !Yt()) _this2.overlayVisible = false;
				};
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createElementBlock("div", mergeProps({
		...
		_ctx.toggleMask && $data.unmasked ? renderSlot(_ctx.$slots, _ctx.$slots.maskicon ? "maskicon" : "hideicon", mergeProps({
			key: 0,
		...
		_ctx.toggleMask && !$data.unmasked ? renderSlot(_ctx.$slots, _ctx.$slots.unmaskicon ? "unmaskicon" : "showicon", mergeProps({
			key: 1,
			toggleCallback: $options.onMaskToggle,
		...
		$options.isClearIconVisible ? renderSlot(_ctx.$slots, "clearicon", mergeProps({
			key: 2,
		...
		createBaseVNode("span", mergeProps({
			...
			"aria-live": "polite"
		}, _ctx.ptm("hiddenAccesible"), { "data-p-hidden-accessible": true }), toDisplayString($data.infoText), 17),
					...
					"default": withCtx(function() {
						return [$data.overlayVisible ? (openBlock(), createElementBlock("div", mergeProps({
							...
							renderSlot(_ctx.$slots, "content", {}, function() {
								return [createBaseVNode("div", mergeProps({ "class": _ctx.cx("content") }, _ctx.ptm("content")), [createBaseVNode("div", mergeProps({ "class": _ctx.cx("meter") }, _ctx.ptm("meter")), [createBaseVNode("div", mergeProps({
									"class": _ctx.cx("meterLabel"),
									style: { width: $data.meter ? $data.meter.width : "" },
									"data-p": $options.meterDataP
								}, _ctx.ptm("meterLabel")), null, 16, _hoisted_3)], 16), createBaseVNode("div", mergeProps({ "class": _ctx.cx("meterText") }, _ctx.ptm("meterText")), toDisplayString($data.infoText), 17)], 16)];
							}),
