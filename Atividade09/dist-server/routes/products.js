...
router.put("/:id", authMiddleware, authorize(Role.ADMIN), validateData(productParamsSchema, "params"), validateData(updateProductSchema), productController.update);
router.delete("/:id", authMiddleware, authorize(Role.ADMIN), validateData(productParamsSchema, "params"), productController.delete);
