import { Cn as withDirectives, Dt as mergeProps, G as createBlock, K as createCommentVNode, M as Fragment, Vt as openBlock, W as createBaseVNode, Xt as resolveDirective, Yt as resolveComponent, Zt as resolveDynamicComponent, cr as toDisplayString, et as createVNode, or as normalizeProps, q as createElementBlock, qt as renderList, r as TransitionGroup, xn as withCtx } from "./vue.runtime.esm-bundler-CKUwx75R.js";
import { J as f, L as _t, _ as l, a as x, t as BaseStyle } from "./style-zV7_3CTQ.js";
import { t as script$7 } from "./basecomponent-CyZyZ_FO.js";
import { t as script$8 } from "./baseicon-I8adJg6o.js";
import "./service-DnAJNl3Q.js";
import { t as Ripple } from "./ripple-DN4y9M0J.js";
import { t as script$9 } from "./times-DD9JzGTY.js";
import { t as script$10 } from "./portal-DksfPocx.js";
import { t as ToastEventBus } from "./toasteventbus-Bm9x6UG1.js";
//#region node_modules/@primeuix/styles/dist/toast/index.mjs
...
var ToastStyle = BaseStyle.extend({
	...
	classes: {
		root: function root(_ref2) {
			return ["p-toast p-component p-toast-" + _ref2.props.position];
		},
...
function render$4(_ctx, _cache, $props, $setup, $data, $options) {
	return openBlock(), createElementBlock("svg", mergeProps({
		...
		fill: "none",
		xmlns: "http://www.w3.org/2000/svg"
	}, _ctx.pti()), _toConsumableArray$3(_cache[0] || (_cache[0] = [
	...
	methods: {
		...
		handleMouseLeave: function handleMouseLeave(event) {
			if (this.onMouseLeave) {
				...
				if (event.defaultPrevented) return;
				if (this.message.life) this.startTimeout();
			}
		}
	},
	computed: {
		iconComponent: function iconComponent() {
			return {
				...
				success: !this.successIcon && script$6,
		...
		dataP: function dataP() {
			return f(_defineProperty$3({}, this.message.severity, this.message.severity));
		}
	},
	components: {
		TimesIcon: script$9,
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createElementBlock("div", mergeProps({
		...
		autofocus: "",
		"data-p": $options.dataP
	}, _objectSpread$1(_objectSpread$1({}, $props.closeButtonProps), _ctx.ptm("closeButton"))), [(openBlock(), createBlock(resolveDynamicComponent($props.templates.closeicon || "TimesIcon"), mergeProps({ "class": [_ctx.cx("closeIcon"), $props.closeIcon] }, _ctx.ptm("closeIcon")), null, 16, ["class"]))], 16, _hoisted_5)), [[_directive_ripple]])], 16)) : createCommentVNode("", true)], 16))], 16, _hoisted_1$1);
}
...
var script = {
	...
	beforeUnmount: function beforeUnmount() {
		this.destroyStyle();
		if (this.$refs.container && this.autoZIndex) x.clear(this.$refs.container);
	...
	methods: {
		...
		onRemoveAllGroups: function onRemoveAllGroups() {
			...
			this.messages.forEach(function(message) {
				return _this.$emit("close", { message });
			});
			this.messages = [];
		},
		onEnter: function onEnter() {
			if (this.autoZIndex) x.set("modal", this.$refs.container, this.baseZIndex || this.$primevue.config.zIndex.modal);
		},
		onLeave: function onLeave() {
			var _this2 = this;
			if (this.$refs.container && this.autoZIndex && l(this.messages)) setTimeout(function() {
	...
	computed: { dataP: function dataP() {
		return f(_defineProperty$1({}, this.position, this.position));
	} },
	components: {
