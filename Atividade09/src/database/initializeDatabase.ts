...
export async function initializeDatabase() {
  await pool.query(`
    ...
    UPDATE cart_items
    SET product_id = '20000000-0000-4000-8000-000000000001'
    WHERE product_id = '20000000-0000-0000-0000-000000000001';

    UPDATE products
    SET id = '20000000-0000-4000-8000-000000000001'
    WHERE id = '20000000-0000-0000-0000-000000000001';

    UPDATE cart_items
    SET product_id = '20000000-0000-4000-8000-000000000002'
    WHERE product_id = '20000000-0000-0000-0000-000000000002';

    UPDATE products
    SET id = '20000000-0000-4000-8000-000000000002'
    WHERE id = '20000000-0000-0000-0000-000000000002';

    UPDATE cart_items
    SET product_id = '20000000-0000-4000-8000-000000000003'
    WHERE product_id = '20000000-0000-0000-0000-000000000003';

    UPDATE products
    SET id = '20000000-0000-4000-8000-000000000003'
